#!/usr/bin/env python3
"""Build the v2 strict-accounting-stress DOCX manuscript draft."""
...
SOURCE = ROOT / "manuscript/strict_accounting_stress_v2_manuscript.md"
OUT = ROOT / "manuscript/strict_accounting_stress_v2_submission_manuscript.docx"
...
def build() -> None:
    ...
    table_specs = [
        ("Table 1. Candidate Samples", "table1_candidate_samples.md", [2.25, 0.9, 0.65, 0.95, 0.85, 0.9, 0.8, 1.0], 7.4),
        ("Table 2. Descriptive Statistics", "table2_descriptive_statistics.md", [2.4, 0.75, 0.75, 0.75, 0.75, 0.75, 0.75], 7.6),
        ("Table 3. Main and Market-Split Logit Estimates", "table3_main_and_market_split.md", [2.25, 0.75, 0.75, 0.82, 0.9, 0.78, 0.8, 0.72, 0.65], 7.1),
        ("Table 4. Robustness Checks", "table4_robustness.md", [2.9, 0.75, 0.75, 0.9, 0.78, 0.82, 0.7], 7.2),
        ("Table 5. Prediction Increment", "table5_prediction_increment.md", [2.8, 0.95, 0.95, 0.85, 0.95, 0.95, 0.85], 7.2),
    ]
